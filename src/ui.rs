...
pub fn technician_ui(){
    ...
    println!("{}{}", spacing2, "[2] Register a guest  |  [7] Indoor sensing".color(Color::White));
    println!("{}{}", spacing2, "[3] View guest(s)     |  [8] Outdoor weather".color(Color::White));
...
pub fn hvac_control_ui() {
    ...
    println!("{}{}", spacing2, "[5] Choose Profile".color(text_color));
    println!("{}{}", spacing2, "[6] Return to Main Menu".color(text_color));

    println!();
    print!("{}","Select an option [1-6]: ".bold().color(Color::Cyan));
}
